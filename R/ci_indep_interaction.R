...
#' difference between the differences of two proportions (i.e. (a1/m1 - b1/n1) and
#' (a2/m2 - b2/n2)) are different using a confidence intervall. If this interval
#' contains 0, we assume that both differences are not significantly different from
#' each other. This corresponds closely to a 2x2 ANOVA when outcomes are dichotomous
#' rather than continuous. See Newcombe (2001).
#' 
...
#'   \item{d}{The difference between differences ((a1/m1 - b1/n1) - (a2/m2 - b2/n2)}
